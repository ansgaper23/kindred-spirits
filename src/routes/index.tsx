...
5. Al aprobar: commit + push a rama nueva + (opcional) apertura automática de PR, con un resumen del cambio generado por el propio modelo como descripción del PR.
